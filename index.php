...
if (isset($_POST['add'])){
	echo "<script>alert('You need to be logged in first!')</script>";
...
<body>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 text-center col-lg-5 text-right col-xl-4 text-right p-3">
					<p class="my-md-4 header-links">
						<a href="Login.php" class="px-3">Sign In</a>
						<a href="SignUp.php" class="px-2">Become a Buyer</a>
					...
					<div class="navbar-nav col-2">
						...
						<a href="Login.php">
							<button type="button" class="btn btn-outline-primary">
								<i class="fas fa-shopping-cart p-1"></i> Cart 
							</button>
						</a>
					</div>
				</div>
	...
	<div class="container-fluid">
		...
		<div id="section3" class="row p-0 pt-4">
	...
	<footer>
		<div class="footer-top mt-5 shadow mb-2 bg-black rounded">
			<div id="footer-header" class="container-fluid">
				<div class="row">
					...
					<div class="col-4 text-center pt-3">
						<h3><i class="fas fa-star p-2"></i>Top Rated</h3>
		...
		<div class="footer-mid pt-2">
			<div class="container-fluid">
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-12 text-center pt-5">
